    ...
    <form action="{{ route('admin.blogs.store') }}" method="POST" enctype="multipart/form-data" id="blogForm">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" name="title" id="blogTitle" placeholder="Enter your captivating post title" required value="{{ old('title') }}">
                    @error('title')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="slug" id="blogSlug" placeholder="enter-your-post-url-slug" required value="{{ old('slug') }}">
                    <div class="slug-preview">
                        <i class="fas fa-link"></i>
                        <span>{{ url('/blog') }}/</span>
                        <span id="slugValue">{{ old('slug') ?: 'your-post-slug' }}</span>
                    </div>
                    @error('slug')
                        <div class="error-message"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                    @enderror
        ...
        <div class="seo-card">
            ...
            <div class="form-group">
                ...
                <input type="text" name="meta_title" id="metaTitle" placeholder="SEO Title (60-70 characters recommended)" value="{{ old('meta_title') }}" maxlength="70">
                <div class="char-counter" id="metaTitleCounter">
                    <span id="metaTitleLength">0</span>/70 characters
                </div>
                @error('meta_title')
                    <div class="error-message"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                @enderror
            ...
            <div class="form-group">
                ...
                <textarea name="meta_description" id="metaDescription" rows="3" placeholder="Brief summary for search engines (150-160 characters recommended)" maxlength="160">{{ old('meta_description') }}</textarea>
...
</script>'>{{ old('schema_markup') }}</textarea>
...
<script>
    ...
    // Initial preview for existing values
    if (titleInput.value) {
        slugValue.textContent = slugInput.value || 'your-post-slug';
    }
</script>
@endsection