...
@php
    $settings = $homepage ?? $websiteSettings ?? null;
...
<div class="hocms-wrapper">
    <div class="hocms-shell">
        ...
        <main class="hocms-main">
            <form action="{{ route('admin.pages.update') }}" method="POST" enctype="multipart/form-data" id="hocmsForm">
                @csrf
                @method('PUT')
                ...
                <div id="hocms-hero" class="hocms-card-wrapper">
                    ...
                    <div class="hocms-section-body">
                        ...
                        <div class="hocms-field-group">
                            <label class="hocms-field-label">Page Title</label>
                            <input type="text" class="hocms-field-input" name="name" 
                                value="{{ $homepage->name }}">
                        </div>
                        <div class="hocms-field-group">
                            <label class="hocms-field-label">Page Slug</label>
                            <input type="text" class="hocms-field-input" name="slug" 
                                value="{{ $homepage->slug }}">
                        </div>
                        <div class="hocms-field-group">
