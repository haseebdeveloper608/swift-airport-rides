...
@section('page_title', 'New FAQ Question')
@section('page_subtitle', 'Add a new question and answer to your FAQs database.')
...
<div class="form-container">
    <form action="{{ route('admin.faqs.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="question" id="question" class="form-control" placeholder="e.g. How do I track my airport transfer?" value="{{ old('question') }}" required>
            @error('question')
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="text" name="category" id="category" class="form-control" list="categoryList" placeholder="e.g. Booking & Fares, Airport Pickups" value="{{ old('category', 'General') }}" required>
            ...
            <div class="form-group">
                ...
                <input type="number" name="sort_order" id="sort_order" class="form-control" placeholder="0" value="{{ old('sort_order', 0) }}">
        ...
        <div class="form-group">
            ...
            <textarea name="answer" id="editor" class="form-control" rows="6" placeholder="Write the detailed answer here...">{{ old('answer') }}</textarea>
            @error('answer')
                <span style="color: var(--danger); font-size: 0.8rem; margin-top: 4px; display: block;">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn btn-primary">
                <i class="fas fa-save"></i> Save FAQ Item
            </button>
        </div>
    </form>
</div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        const form = document.querySelector("form[action='{{ route('admin.faqs.store') }}']");
        if (!form) return;
